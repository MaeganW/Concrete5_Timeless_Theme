...
-->
    ...
    <link rel="stylesheet" href="<?=$view->getThemePath()?>/css/templatemo-style.css">
    <!-- Templatemo style -->
</head>
...
<body>
            ...
            <div class="col-lg-12">
                <div class="tm-video-container">
                    <video id="tm-welcome-video" class="tm-welcome-video" autoplay="" loop="" muted="">
                        <source src="<?=$view->getThemePath()?>/videos/video.mp4" type="video/mp4"> Your browser does not support the video tag.
                        </video>
                ...
                <div class="col-lg-12">
                    <div class=" tm-timeline-item">
                        <div class="tm-timeline-item-inner">
                            <img src="<?=$view->getThemePath()?>/img/img-01.jpg" alt="Image" class="rounded-circle tm-img-timeline">
                    ...
                    <div class="tm-timeline-item">
                        <div class="tm-timeline-item-inner">
                            <img src="<?=$view->getThemePath()?>/img/img-02.jpg" alt="Image" class="rounded-circle tm-img-timeline">
                            <div class="tm-timeline-connector">
                                <p class="mb-0">&nbsp;</p>
                            </div>
                            <div class="tm-timeline-description-wrap">
                    ...
                    <div class="tm-timeline-item">
                        <div class="tm-timeline-item-inner">
                            <img src="<?=$view->getThemePath()?>/img/img-03.jpg" alt="Image" class="rounded-circle tm-img-timeline">
                            <div class="tm-timeline-connector">
                                <p class="mb-0">&nbsp;</p>
                            </div>
                            <div class="tm-timeline-description-wrap">
                    ...
                    <div class="tm-timeline-item">
                        <div class="tm-timeline-item-inner">
                            <img src="<?=$view->getThemePath()?>/img/img-04.jpg" alt="Image" class="rounded-circle tm-img-timeline">
                            <div class="tm-timeline-connector">
                                <p class="mb-0">&nbsp;</p>
                            </div>
                            <div class="tm-timeline-description-wrap">
            ...
            <div class="row tm-section-mt">
                <div class="col-lg-6">
                    ...
                    <!-- How to change your own map point
                           ...
                           4. Copy only URL and paste it within the src="<?=$view->getThemePath()?>/" field below
                       -->
    ...
    <!-- <script src="<?=$view->getThemePath()?>/js/jquery-3.2.1.slim.min.js"></script> -->
    <script src="<?=$view->getThemePath()?>/js/templatemo-script.js"></script>
